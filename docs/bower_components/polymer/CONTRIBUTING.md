...
[`http://localhost:8001/components/polymer/test/runner.html`](http://localhost:8001/components/polymer/test/runner.html)
...
3.  Run the tests:
	...
	<code>http://localhost:8001/components/<var>element-name</var>/test/runner.html</code>
